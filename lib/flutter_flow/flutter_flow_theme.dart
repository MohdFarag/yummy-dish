...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFFFD596);
  ...
  late Color gold = const Color(0xFFFFB004);
  late Color love = const Color(0xFFBD0000);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4B986C);
  late Color secondary = const Color(0xFFFFDFAD);
  late Color tertiary = const Color(0xFF6D604A);
