                      ...
                      child: Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'ev5ruulj' /* Join us & cook with confidence */,
                          ),
                          ...
                          child: RichText(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: FFLocalizations.of(context).getText(
                                    'mdtd1bym' /* Already have an account? */,
                                  ),
